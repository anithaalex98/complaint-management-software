		...
		<table width=100% style="margin:180px 5px 5px 5px;">	
			<tr>
				<td>
					<?php 
						session_start();
						$sql1 = "SELECT first_name, middle_name, last_name, profile, email, user_name FROM users WHERE user_name='".$_SESSION['uname']."' AND user_id='".$_SESSION['uid']."'";
			...
			<hr>
			<div class="menu">
				<td colspan=4 width=40%><a href="admin_dashboard.php">Dashboard</a>
